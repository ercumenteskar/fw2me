	...
	public class servisAT extends AsyncTask<Object, Void, String> { // 8081 //
		...
		protected void onPostExecute(String result) {
			...
			try {
				...
				else if (mtype.equals("GetMyMailSenderList"))
		...
		try {
			...
			for (int i = 0; i < conns.length(); i++) {
				...
				conn.put(TAG_SenderName, (SenderActive != "true" ? getResources()
				    .getString(R.string.lbActive) + " " : "") + SenderName);
			...
			ListAdapter adapter = new SimpleAdapter(getApplicationContext(),
			    connArray, R.layout.mymailsender_list_item,
			    new String[] { TAG_Id, TAG_SenderEMail, TAG_SenderName, TAG_OrjSenderName,
			        TAG_CreatedDT, TAG_SenderActive }, new int[] { R.id.tvId,
			        R.id.tvSenderEMail, R.id.tvSenderName, R.id.tvOrjSenderName, R.id.tvCreatedDT,
			        R.id.tvSenderActive });
